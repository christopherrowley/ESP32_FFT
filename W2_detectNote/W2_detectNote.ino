...
const uint16_t  SAMPLES = 1024; // arduinoFFT 2.0.3 - must be a power of 2. As of this version 2048 and 4096 do NOT work. 
const float SAMPLING_FREQ = 8192; // Hz, must be 40000 or less due to ADC conversion time. Determines maximum frequency that can be analysed by the FFT Fmax=sampleF/2.
